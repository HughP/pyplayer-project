...
#
# Created: Thu Jul 05 00:37:15 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        item = QtGui.QTableWidgetItem()
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/star.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon7)
        self.tableWidget.setHorizontalHeaderItem(7, item)
        item = QtGui.QTableWidgetItem()
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/file_size.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon8)
        ...
        self.clearPlsButton.setMinimumSize(QtCore.QSize(24, 24))
        self.clearPlsButton.setText(_fromUtf8(""))
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/del_pls.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clearPlsButton.setIcon(icon9)
        self.clearPlsButton.setCheckable(False)
        self.clearPlsButton.setChecked(False)
        self.clearPlsButton.setObjectName(_fromUtf8("clearPlsButton"))
        self.verticalLayout_2.addWidget(self.clearPlsButton)
        self.savePlsButton = QtGui.QPushButton(self.tab_3)
        self.savePlsButton.setMinimumSize(QtCore.QSize(24, 24))
        self.savePlsButton.setText(_fromUtf8(""))
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/save_playlist.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.savePlsButton.setIcon(icon10)
        self.savePlsButton.setObjectName(_fromUtf8("savePlsButton"))
        self.verticalLayout_2.addWidget(self.savePlsButton)
        self.randomButton = QtGui.QPushButton(self.tab_3)
        ...
        self.randomButton.setMinimumSize(QtCore.QSize(24, 24))
        self.randomButton.setText(_fromUtf8(""))
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/random.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.randomButton.setIcon(icon11)
        ...
        self.repeatButton = QtGui.QPushButton(self.tab_3)
        self.repeatButton.setText(_fromUtf8(""))
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/repeat.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.repeatButton.setIcon(icon12)
        self.repeatButton.setCheckable(True)
        self.repeatButton.setObjectName(_fromUtf8("repeatButton"))
        self.verticalLayout_2.addWidget(self.repeatButton)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/control_start_blue.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.prevButton.setIcon(icon13)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/control_stop_blue.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stopButton.setIcon(icon15)
        self.stopButton.setObjectName(_fromUtf8("stopButton"))
        self.horizontalLayout_3.addWidget(self.stopButton)
        self.pushButton = QtGui.QPushButton(self.centralwidget)
        self.pushButton.setText(_fromUtf8(""))
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/control_end_blue.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/newPrefix/settings.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.settingsButton.setIcon(icon17)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(QtGui.QApplication.translate("MainWindow", "Оценка", None, QtGui.QApplication.UnicodeUTF8))
        ...
        item.setText(QtGui.QApplication.translate("MainWindow", "Кол-во проигрываний", None, QtGui.QApplication.UnicodeUTF8))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(QtGui.QApplication.translate("MainWindow", "ID", None, QtGui.QApplication.UnicodeUTF8))
        self.clearPlsButton.setToolTip(QtGui.QApplication.translate("MainWindow", "Очистить окно", None, QtGui.QApplication.UnicodeUTF8))
        self.savePlsButton.setToolTip(QtGui.QApplication.translate("MainWindow", "Сохранить в плейлист [Ctrl+S]", None, QtGui.QApplication.UnicodeUTF8))
        self.randomButton.setToolTip(QtGui.QApplication.translate("MainWindow", "Вкл/Выкл рандом", None, QtGui.QApplication.UnicodeUTF8))
        self.repeatButton.setToolTip(QtGui.QApplication.translate("MainWindow", "Вкл/Выкл повтор", None, QtGui.QApplication.UnicodeUTF8))
